...
//OSP版本信息
#define OSPVERSION				"OSP 40.11.01.10.070126"
//OSP版本号
...
功能：改变任务的优先级。
 ...
 输入参数说明：
  ...
  返回值说明：
====================================================================*/
API BOOL32 OspTaskSetPriority(TASKHANDLE taskHandle, u8 newPriority);
...
功能：获得任务的优先级。
 ...
 输入参数说明：
  ...
  返回值说明：
====================================================================*/
API BOOL32 OspTaskGetPriority(TASKHANDLE taskHandle, u8 * puPri);
