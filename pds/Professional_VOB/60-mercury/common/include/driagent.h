...
#define DEBUG_LVL     2   // 一般信息
#define IMPORTANT_LVL 1   // 重要信息
#define FATAL_LVL     0   // 致命信息

// 定义单板管理程序最大的实例数目
#define BOARD_AGENT_MAX_INSTANCE	1

// 重新连接MPC上管理程序的定时器时长(3秒)
#define POWEN_ON_CONNECT            200
#define CONNECT_MANAGER_TIMEOUT		3000

// 注册等待定时器时长(2秒)
#define REGISTER_TIMEOUT		3000

// 取配置信息等待定时器时长(3秒)
#define GET_CONFIG_TIMEOUT		3000
...
protected:
    ...
    void ProcTestTimer(void);
    void ProcTestTimer1(void);
private:
