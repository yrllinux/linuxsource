...
####前120s，每隔2s检测一下mcu8ke看是否mcu启动成功,0表示已升级，1表示正常，成功则退出脚本####
FILEPATH="/opt/mcu/data/runstatus_8ke.stchk";
...
#after 120s,mcu8ke still =0,roolback,reboot
