...
// 							THDAdaptParam tHDParm, BOOL32 bForceSet = FALSE, BOOL32 bAdjRes = FALSE);
	...
	BOOL32 SetMpIpType(u8 byMpId, u8 byIpType);//[pengguofeng 5/10/2012]IPV6 
	u8 GetMpIpType( u8 byMpId);
	...
	BOOL32 SetMtAdpIpType( u8 byMtAdpId, u8 byIpType);//[pengguofeng 5/10/2012]IPV6 
	u8 GetMtAdpIpType( u8 byMtAdpId );
	BOOL32 IsMtIpV6( u32 dwIp);
...
//	void IncMtAdpMtNum( u8 byDriId, u8 byConfIdx, u8 byMtId, u16 wIncExtraNum = 0);
	...
	u8 GetH323MtDriId( TMtAlias &tMtAlias );
