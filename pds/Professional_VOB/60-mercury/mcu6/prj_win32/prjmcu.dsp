...
# ADD LINK32 lanman.lib kdvlog.lib osplib.lib kdvsys.lib winbrdwrapper.lib mcuagt.lib windataswitch.lib mp6.lib mtadp6.lib kdv323.lib kdv323adp.lib kdvaddrbook.lib kdvdatanet.lib fcnet.lib enfc.lib kdvmedianet.lib mcuprs.lib kdvnetbuf.lib kdvencrypt.lib snmpadp_mcu.lib agent_pp.lib snmp_pp.lib kdvum.lib kdvcascade.lib readlicenselib.lib h460pinholelib.lib /nologo /subsystem:windows /machine:I386 /nodefaultlib:"nafxcw.lib" /nodefaultlib:"libc.lib" /nodefaultlib:"libcmt.lib" /out:"mcu6.exe" /libpath:"..\..\..\10-common\lib\release\win32"
...
# ADD LINK32 h460pinholelib.lib lanman.lib kdvlog.lib osplib.lib kdvsys.lib winbrdwrapper.lib mcuagt.lib windataswitch.lib mp6.lib mtadp6.lib kdv323.lib kdv323adp.lib kdvaddrbook.lib kdvdatanet.lib fcnet.lib enfc.lib kdvmedianet.lib mcuprs.lib kdvnetbuf.lib kdvencrypt.lib snmpadp_mcu.lib agent_pp.lib snmp_pp.lib kdvum.lib kdvcascade.lib readlicenselib.lib /nologo /stack:0x7a1200 /subsystem:windows /debug /machine:I386 /nodefaultlib:"nafxcwd.lib" /nodefaultlib:"libcd.lib" /nodefaultlib:"libcmtd.lib" /out:"mcu6.exe" /pdbtype:sept /libpath:"..\..\..\10-common\lib\debug\win32"
# SUBTRACT LINK32 /pdb:none
