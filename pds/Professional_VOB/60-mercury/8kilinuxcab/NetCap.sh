...
#this script is used to start or stop tcpdump cmd file: /usr/mcu/temp/CapChoice 
#content 1:start,0:stop,x:nothing
SAVEFILE=/usr/mcu/temp/UsrNetCap
CAPCHOICEFILE=/usr/mcu/temp/CapChoice
EACHFILESIZE=40
FILENUM=5
sleepinterval=3
mkdir -p /usr/mcu/temp/
chmod 777 /usr/mcu/temp/
