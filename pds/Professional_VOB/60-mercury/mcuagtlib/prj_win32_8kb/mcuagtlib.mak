...
ALL : "..\..\..\10-common\lib\release\win32\mcuagtmt.lib"
...
"..\..\..\10-common\lib\release\win32\mcuagtmt.lib" : "$(OUTDIR)" $(DEF_FILE) $(LIB32_OBJS)
    $(LIB32) @<<
...
ALL : "..\..\..\10-common\lib\debug\win32\mcuagtmt.lib"
...
CLEAN :
	...
	-@erase "..\..\..\10-common\lib\debug\win32\mcuagtmt.lib"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP_PROJ=/nologo /MLd /W3 /Gm /GX /ZI /Od /I "..\include" /I "..\..\common\include" /I "..\..\..\10-common\include\mcu" /I "..\..\..\10-common\include\platform" /I "..\..\..\10-common\include\system1" /I "..\..\..\10-common\include\snmp" /I "..\..\..\10-common\include\protocol" /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_LIB" /D "_MINIMCU_" /D "_UTF8" /Fp"$(INTDIR)\mcuagtlib.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\mcuagtlib.bsc" 
BSC32_SBRS= \
	
LIB32=link.exe -lib
LIB32_FLAGS=/nologo /out:"..\..\..\10-common\lib\debug\win32\mcuagtmt.lib" 
LIB32_OBJS= \
	"$(INTDIR)\AgentInterface.obj" \
	"$(INTDIR)\agentmsgcenter.obj" \
	"$(INTDIR)\AgentSnmp.obj" \
...
"..\..\..\10-common\lib\debug\win32\mcuagtmt.lib" : "$(OUTDIR)" $(DEF_FILE) $(LIB32_OBJS)
    $(LIB32) @<<
  $(LIB32_FLAGS) $(DEF_FLAGS) $(LIB32_OBJS)
<<
