...
protected:
    ...
    void AddrEntryIn2Out(TMcuAddrEntry *ptAddrIn, TADDRENTRY *ptAddrOut, u8 byNum=1);
    void AddrGroupIn2Out(TMcuAddrGroup *ptGroupIn, TADDRMULTISETENTRY *ptGroupOut, u8 byNum=1);
...
public:
    ...
    void DaemonProcPowerOn( const CMessage * const pcMsg  );
