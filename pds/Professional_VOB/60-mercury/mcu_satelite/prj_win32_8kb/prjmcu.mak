...
LINK32=link.exe
LINK32_FLAGS=multimtsimu.lib osplib.lib kdvsys.lib mcuagt.lib dataswitch.lib mp.lib mtadp.lib kdvaddrbook.lib kdvdatanet.lib fcnet.lib enfc.lib kdvmedianet.lib mcuprs.lib kdvnetbuf.lib kdvencrypt.lib snmpadp_mcu.lib agent_pp.lib snmp_pp.lib kdvum.lib kdvcascade.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\mcu.pdb" /debug /machine:I386 /nodefaultlib:"nafxcwd.lib" /nodefaultlib:"libcd.lib" /nodefaultlib:"libcmtd.lib" /out:"mcu.exe" /pdbtype:sept /libpath:"..\..\..\10-common\lib\debug\win32" 
LINK32_OBJS= \
	"$(INTDIR)\dcsssn.obj" \
	"$(INTDIR)\eqpssn.obj" \
	"$(INTDIR)\mcsssn.obj" \
...
LINK32=link.exe
LINK32_FLAGS=multimtsimu.lib osplib.lib kdvsys.lib mcuagt.lib dataswitch.lib mp.lib mtadp.lib kdvaddrbook.lib kdvdatanet.lib fcnet.lib enfc.lib kdvmedianet.lib mcuprs.lib kdvnetbuf.lib kdvencrypt.lib snmpadp_mcu.lib agent_pp.lib snmp_pp.lib kdvum.lib kdvcascade.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\mcu.pdb" /machine:I386 /nodefaultlib:"nafxcw.lib" /nodefaultlib:"libc.lib" /nodefaultlib:"libcmt.lib" /out:"mcu.exe" /libpath:"..\..\..\10-common\lib\release\win32" 
LINK32_OBJS= \
	"$(INTDIR)\dcsssn.obj" \
	"$(INTDIR)\eqpssn.obj" \
	"$(INTDIR)\mcsssn.obj" \
