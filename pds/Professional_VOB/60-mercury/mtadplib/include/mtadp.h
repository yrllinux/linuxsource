...
// 	void MtInfo2Part( TPartU *ptPart, TMcuMcuMtInfo *ptInfo );
// 	void Part2MtInfo( TPartU *ptPart, TMcuMcuMtInfo *ptInfo );
...
public: 
	...
	void	SetStackInitUtf8( BOOL32 bUtf8); //  [pengguofeng 9/12/2013]
