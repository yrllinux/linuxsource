...
ALL : "..\..\..\10-Common\lib\release\win32\bashdmt.lib"
...
CLEAN :
	...
	-@erase "..\..\..\10-Common\lib\release\win32\bashdmt.lib"
...
LIB32=link.exe -lib
LIB32_FLAGS=/nologo /out:"..\..\..\10-Common\lib\release\win32\bashdmt.lib" 
LIB32_OBJS= \
	"$(INTDIR)\basApp.obj" \
	"$(INTDIR)\basInst.obj"

"..\..\..\10-Common\lib\release\win32\bashdmt.lib" : "$(OUTDIR)" $(DEF_FILE) $(LIB32_OBJS)
    $(LIB32) @<<
...
ALL : "..\..\..\10-Common\lib\debug\win32\bashdmt.lib" "$(OUTDIR)\baslib.bsc"
...
CLEAN :
	...
	-@erase "..\..\..\10-Common\lib\debug\win32\bashdmt.lib"
...
LIB32=link.exe -lib
LIB32_FLAGS=/nologo /out:"..\..\..\10-Common\lib\debug\win32\bashdmt.lib" 
LIB32_OBJS= \
	"$(INTDIR)\basApp.obj" \
	"$(INTDIR)\basInst.obj"

"..\..\..\10-Common\lib\debug\win32\bashdmt.lib" : "$(OUTDIR)" $(DEF_FILE) $(LIB32_OBJS)
    $(LIB32) @<<
  $(LIB32_FLAGS) $(DEF_FLAGS) $(LIB32_OBJS)
<<
