...
_zzip_export
ZZIP_DIR *  	zzip_dir_fdopen(void *mem, zzip_size_t size, zzip_error_t * errcode_p);
_zzip_export
ZZIP_DIR *  	zzip_dir_open(void *mem, zzip_size_t size, zzip_error_t * errcode_p);
...
#else
_zzip_export
ZZIP_DIR * 	zzip_opendir(void *mem, zzip_ssize_t size);
/* 获取Zip文件的压缩文件实际大小 */
_zzip_export
int zzip_zipfile_size(void *mem, zzip_ssize_t size, zzip_char_t* filename);
/* 解压指定文件到指定路径 */
_zzip_export
int zzip_uncom_file(void *mem, zzip_ssize_t size, zzip_char_t* filename, zzip_char_t* destfile);
#endif
...
#else
_zzip_export
ZZIP_FILE * 	zzip_open(void *mem, zzip_ssize_t size, int flags);
#endif
_zzip_export
...
#else
_zzip_export
ZZIP_FILE*      zzip_freopen(void *mem, zzip_ssize_t size, zzip_char_t* mode, ZZIP_FILE*);
_zzip_export
ZZIP_FILE*      zzip_fopen(void *mem, zzip_ssize_t size, zzip_char_t* mode);
#endif
_zzip_export
...
_zzip_export
ZZIP_FILE * zzip_open_shared_io(ZZIP_FILE* stream,
				void* mem, zzip_ssize_t size, int o_flags, int o_modes,
				zzip_strings_t* ext, zzip_plugin_io_t io);

_zzip_export
ZZIP_FILE * zzip_open_ext_io(void* mem, zzip_ssize_t size, int o_flags, int o_modes,
			     zzip_strings_t* ext, zzip_plugin_io_t io);

_zzip_export
ZZIP_DIR *  zzip_opendir_ext_io(void* mem, zzip_ssize_t size, int o_modes,
				zzip_strings_t* ext, zzip_plugin_io_t io);

_zzip_export
ZZIP_DIR *  zzip_dir_open_ext_io(void* mem, zzip_ssize_t size,
				 zzip_error_t* errcode_p,
				 zzip_strings_t* ext, zzip_plugin_io_t io);
#endif
