...
typedef struct zzip_mem_t zzip_mem;

int _zip_open_mem(zzip_mem* zip_mem, void* mem, long size);
int _zip_close_mem(zzip_mem* zip_mem);
zzip_ssize_t _zzip_read_mem(zzip_mem* zip_mem, void* buf, zzip_size_t len);
zzip_off_t _zzip_lseek_mem(zzip_mem* zip_mem, zzip_off_t offset, int whence);
zzip_off_t zzip_filesize_mem(zzip_mem* zip_mem);
zzip_ssize_t _zzip_write_mem(zzip_mem* zip_mem, _zzip_const void* buf, zzip_size_t len);

struct zzip_plugin_io { /* use "zzip_plugin_io_handlers" in applications !! */
    int          (*open)(zzip_mem* zip_mem, void* mem, long size);
    int          (*close)(zzip_mem* zip_mem);
    zzip_ssize_t (*read)(zzip_mem* zip_mem, void* buf, zzip_size_t len);
    zzip_off_t   (*seeks)(zzip_mem* zip_mem, zzip_off_t offset, int whence);
    zzip_off_t   (*filesize)(zzip_mem* zip_mem);
    long         sys;
    long         type;
    zzip_ssize_t (*write)(zzip_mem* zip_mem, _zzip_const void* buf, zzip_size_t len);
};
#endif
