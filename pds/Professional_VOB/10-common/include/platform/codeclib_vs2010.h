...
#define AUDIO_MODE_AACLD_32_SINGLE	(u8)20
...
#define  CAP_FRAME_MJPG			 (u8)3 //手机
#define  CAP_FRAME_YUY2			 (u8)4 //无驱动摄像头yuv422
#define  CAP_FRAME_ERROR		 (u8)5
...
//关键帧请求回调 gdw
typedef void (*PREQKEYFRAMEFUN)(void *pDecoder, u32 dwContext); 
...
//	u16    SetWaveOutAudioDevice(CString strContainText);
	...
	//设置关键帧请求回调函数 gdw
	void SetKeyFrameFuncCallBack(PREQKEYFRAMEFUN pCBFunc);
...
*/
	...
	BOOL32 SetBackJpegImage(s8 *data, u32 dwsize);
