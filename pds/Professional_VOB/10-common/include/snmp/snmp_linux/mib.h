...
typedef struct mib_node{
	char * name;
	struct mib_node * p_next;
}mib_node;

typedef struct mib_file_node{
	char * name;
	struct mib_file_node * p_next;
	struct mib_file_node * p_child;
	struct mib_file_node * p_parent;	
}mib_file_node;
