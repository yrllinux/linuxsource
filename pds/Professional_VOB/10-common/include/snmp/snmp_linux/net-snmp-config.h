...
//#define DEFAULT_MIBS "SNMPv2-MIB:RFC1213-MIB"
#define DEFAULT_MIBS "all"
/* default location to look for mibs to load using the above tokens
   and/or those in the MIBS envrionment variable*/
#define DEFAULT_MIBDIRS "/usr/etc/mibs/"
#define DEFAULT_MIBBASEDIRS "/usr/etc/mibs/public/base/"
...
#define PERSISTENT_DIRECTORY "/usr/tmp/net-snmp"
...
#define SYSTEM_INCLUDE_FILE "linux.h"

/* define the machine (cpu) type include file here */
#define MACHINE_INCLUDE_FILE "generic.h"
...
#define SNMPLIBPATH "/opt/eldk/ppc_82xx/usr/lib/snmp"
#define SNMPSHAREPATH "/opt/eldk/ppc_82xx/usr/share/snmp"
#define SNMPCONFPATH "/opt/eldk/ppc_82xx/usr/etc/snmp"
#define SNMPDLMODPATH "/opt/eldk/ppc_82xx/usr/lib/snmp/dlmod"
...
/* Use dmalloc to do XMALLOC debugging? */
...
#define ETC_MNTTAB "/usr/etc/mtab"
...
#define NETSNMP_TEMP_FILE_PATTERN "/usr/tmp/snmpdXXXXXX"
...
/* Define to 1 if you have the <XMALLOC.h> header file. */
...
#define CONFIGURE_OPTIONS "\"'--host=ppc-linux' '--target=ppc-linux' '--prefix=/opt/eldk/ppc_82xx/usr' '--with-mib-modules=agentx' '--with-endianness=big' '--disable-agent' '--disable-applications' '--disable-manuals' '--disable-scripts' '--disable-mibs' 'host_alias=ppc-linux' 'target_alias=ppc-linux'\""
