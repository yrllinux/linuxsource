...
extern void set_snmp_error_func(int x);

#ifndef DONT_SHARE_ERROR_WITH_OTHER_THREADS
#define SET_SNMP_ERROR(x) set_snmp_error_func(x)
#else
...
//#define MAX_PACKET_LEN 	17940 /*by cicso cmd style*/
...
#define NETSNMP_CALLBACK_OP_DISCONNECT		5
	...
	void 	snmp_set_max_packet_size(unsigned int packet_size);
	void   	snmp_set_default_max_packet_size();
