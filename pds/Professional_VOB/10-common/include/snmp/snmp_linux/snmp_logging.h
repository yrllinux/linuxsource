...
#else
/*zlog Ìæ»»snmp_log.c api interface*/
#ifndef DEFAULT_LOG_ID
#define DEFAULT_LOG_ID "net-snmp"
#endif
...
void 	   snmp_log_enable(const char *token, char *param);

void           snmp_log_disable(const char *token, char *param);

int           snmp_log_get_enable();
