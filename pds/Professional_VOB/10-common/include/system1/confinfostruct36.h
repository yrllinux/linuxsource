/*****************************************************************************
   模块名      : MCU
   文件名      : confinfostruct36.h (mastruct36.h)
   相关文件    : 
   文件实现功能: 3.6版本兼容结构定义 (同步自12月21日的3.6版本)
   作者        : 许世林
   版本        : V4.6  Copyright(C) 2005-2006 KDC, All rights reserved.
-----------------------------------------------------------------------------
   修改记录:
   日  期      版本        修改人                     修改内容
   2005/12     4.0         许世林        创建(目前只同步终端状态与会议信息结构)
   2011/4      4.6         苗庆松        解决TConfInfo版本兼容移至10-Common目录下
******************************************************************************/
...
public:
	...
	{
		OspPrintf( TRUE, FALSE, "\nvideo support: ");
		if( m_bySupportH261 )OspPrintf( TRUE, FALSE, "H.261 " );
		if( m_bySupportH262 )OspPrintf( TRUE, FALSE, "H.262 " );
		if( m_bySupportH263 )OspPrintf( TRUE, FALSE, "H.263 " );
		if( m_bySupportH264 )OspPrintf( TRUE, FALSE, "H.264 " );
		if( m_bySupportMPEG4 )OspPrintf( TRUE, FALSE, "MPEG-4 " );
		OspPrintf( TRUE, FALSE, "\naudio support: ");
		if( m_bySupportG711A )OspPrintf( TRUE, FALSE, "G711A " );
		if( m_bySupportG711U )OspPrintf( TRUE, FALSE, "G711U " );
		if( m_bySupportG722  )OspPrintf( TRUE, FALSE, "G722 " );
		if( m_bySupportG7231 )OspPrintf( TRUE, FALSE, "G7231 " );
		if( m_bySupportG728 )OspPrintf( TRUE, FALSE, "G728 " );
		if( m_bySupportG729 )OspPrintf( TRUE, FALSE, "G729 " );
		if( m_bySupportMP3  )OspPrintf( TRUE, FALSE, "MP3 " );
...
public:
    ...
    {
        OspPrintf( TRUE, FALSE, "\nConfAttrb:\n" );
        OspPrintf( TRUE, FALSE, "m_byMeetingRoom: %d\n", m_byMeetingRoom);
        ...
        OspPrintf( TRUE, FALSE, "m_byDStreamType: %d\n", m_byDStreamType);
    }
}PACKED;
