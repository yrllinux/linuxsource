...
disk init name = "sus_db", physname = "/opt/sybase/data/sus.dat", size = "256M"
go

disk init name = "sus_log", physname = "/opt/sybase/data/sus.log", size = "128M"
go

disk init name = "sustemp_db", physname = "/opt/sybase/data/sustemp.dat", size = "128M"
go

disk init name = "sustemp_log", physname = "/opt/sybase/data/sustemp.log", size = "64M"
go
